...
<my:pagetemplate title="Edit Service Type">
<jsp:attribute name="body">
    <form:form method="post"
               action="${pageContext.request.contextPath}/serviceType/edit/${serviceType.id}"
               modelAttribute="serviceType" cssClass="form-horizontal">
        ...
        <button class="btn btn-primary" type="submit">Edit Service Type</button>
        </form:form>
